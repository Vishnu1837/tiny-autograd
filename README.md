...
[![tests](https://github.com/Vishnu1837/tiny-autograd/actions/workflows/test.yml/badge.svg)](https://github.com/Vishnu1837/tiny-autograd/actions/workflows/test.yml)
...
```bash
git clone https://github.com/Vishnu1837/tiny-autograd.git
cd tiny-autograd
pip install -r requirements.txt   # numpy + matplotlib

# Run the gradient tests (28 finite-difference checks)
...
A more detailed build journal lives in [notes.md](notes.md) — bugs encountered, decisions made, things that surprised me.
